...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2026 at 07:44 PM
...
INSERT INTO `borrow_request` (`br_id`, `mem_id`, `br_type`, `br_amount`, `br_months_pay`, `guarantee_type`, `guarantor_1`, `guarantor_2`, `guarantor_1_id`, `guarantor_2_id`, `guarantor_1_approve`, `guarantor_2_approve`, `guarantor_1_approve_date`, `guarantor_2_approve_date`, `br_details`, `br_respond`, `br_status`, `br_approve_by`, `br_interest_rate`, `br_date_request`, `br_date_approve`) VALUES
(5, '1111111111111', '2', 5000, 5, '1', '33', '444', NULL, NULL, 1, 1, NULL, NULL, '...', '', 1, '0000000000000', 9, '2026-02-23 23:30:21', '2026-02-23 23:30:47'),
(6, '3333333333333', '1', 40000, 40, '1', '1111', '444', NULL, NULL, 1, 1, NULL, NULL, '...', '', 1, '0000000000000', 9, '2026-02-23 23:37:38', '2026-02-23 23:37:47');
...
--
ALTER TABLE `borrowing`
  MODIFY `bw_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
